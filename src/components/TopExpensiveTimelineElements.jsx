...
function TopExpensiveTimelineElements() {
  return (
    <div className='flex flex-col md:flex-row android:flex android:flex-row justify-between items-center gap-4 android:gap-[2px] md:gap-12'>
        ...
        <div  className='flex items-center gap-[12px] android:gap-[2px] '>
            <h3 className='text-base font-medium text-[#222834]'>
